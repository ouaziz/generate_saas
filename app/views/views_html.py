...
from apps.{{ app_name }}.services.{{ model_name.lower() }}.services import list_{{ model_name.lower() }}, get_{{ model_name.lower() }}
from apps.{{ app_name }}.models import {{ model_name }}
from apps.{{ app_name }}.forms import {{ model_name }}Form
